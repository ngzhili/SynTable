        ...
        for i in range(len(self.viewports)):
            ...
            if i == 0 or self.sample("groundtruth_stereo"):
                ...
                if "instanceSegmentation" in gt["state"]:
                    ...
                    # print("instance_map")
                    # print(list(np.unique(instance_data)))
            ...
            for obj in objects:
                ...
                if instance_id != 0: # find object instance segmentation
                    # print("curr_instance_data_np\n",curr_instance_data_np)
                    # print("org_instance_data_np\n",org_instance_data_np)
                    # print("instance_id\n",instance_id)
